...
* The number of beats in system_script.json must match the number of beats in the Episode.
  </non-negotiable rules>
...
The total number of beats is {BEATS_NUMBER}. 
The global_style_guidance is  {GLOBAL_STYLE_GUIDE}
