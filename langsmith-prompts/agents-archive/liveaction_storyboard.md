...
* The KEYFRAME description MUST include photoreal live-action rendering cues (natural skin texture, practical lighting, film grain) appropriate to the global_style_guide.
...
Context & Theme: ...
Characters & Interaction: KEYFRAME_A (shot_size=IS, framing=rule_of_thirds, camera_height=eye_level, azimuth_deg=35, focus=lock and hand; photoreal live-action) ... KEYFRAME_B ... KEYFRAME_C ... KEYFRAME_D ... KEYFRAME_E ... KEYFRAME_F ...
Narrative Tension: ...
